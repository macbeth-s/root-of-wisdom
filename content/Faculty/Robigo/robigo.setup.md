...
`talk.faculty.robigo.setup.intro`<br>
...
### A Conversation with Dottore Robigo
`talk.faculty.robigo.setup.failure`<br>
...
### A Conversation with Dottore Robigo
`talk.faculty.robigo.setup.journal`<br>
...
### A Conversation with Dottore Robigo
`talk.faculty.robigo.prove.intro`<br>
...
<br>**Slot for Skill**
### A Conversation with Dottore Robigo
`talk.faculty.robigo.prove.failure`<br>
...
### A Conversation with Dottore Robigo
`talk.faculty.robigo.prove.success`<br>
